 ...
 */
 // line 112 - Added content_div class to resolve top nav menu buttons conflict - darren 7/31/2012
 // line 36 - changed showModal from true to false; - diane - 3/18/13
(function($, undefined ) {
  $.widget( "mobile.simpledialog2", $.mobile.widget, {
	...
	_create: function () {
		...
		self.dialogPage.appendTo( $.mobile.pageContainer.content_div ) //Added content_div class to resolve top nav menu buttons conflict - darren 7/31/2012
